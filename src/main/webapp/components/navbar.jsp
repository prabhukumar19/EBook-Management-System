		...
		<div class="row">
			...
			<div class="col-md-4">
				<form class="d-flex ">
					<input class="form-control me-2" type="search" placeholder="Search"
						aria-label="Search">
					<button
						class="btn btn-outline-success my-2 my-sm-0 d-flex p-2 justify-content-center align-items-center gap-1 "
						type="submit">
			...
			<div class="col-md-3 text-center">
				<a href="" class="btn btn-success "><i
					class="fa-solid fa-arrow-right-to-bracket"></i> Login</a> <a href=""
					class="btn btn-primary "><i class="fa-solid fa-user-plus"></i>
					Register</a>
			</div>
